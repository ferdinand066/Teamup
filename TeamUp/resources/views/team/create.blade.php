        ...
        <div class="mt-5 md:mt-0 md:col-span-2">
          <div class="space-y-6" action="/team/create/insert-team" method="POST">
            ...
            <div>
              ...
              <div class="mt-1">
                <textarea id="short_description" name="short_description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Tell about the team"></textarea>
              </div>
          ...
          <div>
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6">
                ...
                <div class="mt-1">
                  <textarea id="full_description" name="full_description" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Tell about the team"></textarea>
                </div>
                <p class="mt-2 text-sm text-gray-500">
          ...
          <div>
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6">
                ...
                <div class="mt-1">
                  <textarea id="street" name="street" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Example Road, Near Example Tower or something else..."></textarea>
                </div>
              </div>
